...
const InvoiceForm = () => {
  ...
  useEffect(() => {
    ...
    dueDateObject.setDate(currentDate.getDate() + 7); 
    setDueDate(dueDateObject.toLocaleDateString("en-US", options));
  }, []);
    ...
    >
      <div className="my-6 flex-1 space-y-2  rounded-md bg-white p-4 shadow-sm sm:space-y-4 md:p-6">
        ...
        <div className="grid grid-cols-2 gap-2 pb-8 pt-4">
          <label htmlFor="BillTo" className="text-sm font-bold sm:text-base">
            Bill to:
          </label>
          <input
            required
          ...
          <input
            required
            className="flex-1"
            placeholder="who's this invoice from"
            type="text"
            name="billfrom"
            id="billfrom"
            value={billFrom}
          ...
          <label htmlFor="BillFrom"className="col-start-2 row-start-1 text-sm font-bold md:text-base">Bill From:</label>         
          <input
            required
            className="flex-1"
            placeholder="Billing Address"
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                ...
                />
                <span className="rounded-r-md bg-gray-200 px-4 py-2 text-gray-500 shadow-sm">
                  %
                </span>
              </div>
            </div>
